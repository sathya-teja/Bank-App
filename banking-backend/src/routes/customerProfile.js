...
import { createOrUpdateProfile, getMyProfile, listProfiles, updateKycStatus, listPendingProfiles } from '../controllers/customerProfileController.js';
...
router.get('/pending', authMiddleware, requireRole('admin'), listPendingProfiles);
